...
class context_bound_scheduler
    : public tree_search_scheduler<context_bound_scheduler<thread_count>, context_bound_scheduler_thread_info<thread_count>, thread_count> {
public:
  typedef tree_search_scheduler<context_bound_scheduler<thread_count>, context_bound_scheduler_thread_info<thread_count>, thread_count> base_t;
