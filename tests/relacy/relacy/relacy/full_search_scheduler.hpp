...
public:
  ...
  tree_search_scheduler(test_params& params, shared_context_t& ctx, thread_id_t dynamic_thread_count)
      : base_t(params, ctx, dynamic_thread_count), stree_depth_(), iteration_count_mean_(),
...
class full_search_scheduler
    : public tree_search_scheduler<full_search_scheduler<thread_count>, tree_search_scheduler_thread_info<thread_count>, thread_count> {
public:
  typedef tree_search_scheduler<full_search_scheduler<thread_count>, tree_search_scheduler_thread_info<thread_count>, thread_count> base_t;
  typedef typename base_t::thread_info_t thread_info_t;
  typedef typename base_t::shared_context_t shared_context_t;
