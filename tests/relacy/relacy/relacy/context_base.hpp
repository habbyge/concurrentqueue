...
class context
    : public thread_local_context_iface, public context_addr_hash_iface, nocopy<> {
public:
  ...
  mutex_ctor(bool is_rw, bool is_exclusive_recursive, bool is_shared_recursive, bool failing_try_lock) = 0;
...
protected:
  ...
  context(thread_id_t thread_count, test_params& params)
      : history_(*params.output_stream, thread_count), params_(params), disable_alloc_(1) {
